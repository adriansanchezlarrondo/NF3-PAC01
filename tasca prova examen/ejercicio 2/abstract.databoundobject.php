...
abstract class DataBoundObject {
   ...
   public function __construct(PDO $objPDO, $id = NULL, $LOG = NULL, $ClassName = NULL) {
      ...
      if (isset($LOG)) {
         $this->log = $ClassName::getInstance();
      } 
   ...
   public function __call($strFunction, $arArguments) {      
      ...
      var_dump($this->log);
      $this->log->logMessage('ERROR 500.', $this->className::WARNING, $IdLog, $isActive);
